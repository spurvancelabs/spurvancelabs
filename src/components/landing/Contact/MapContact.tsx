...
function MapContact() {
  return (
    <div className="flex flex-col md:flex-row gap-8 sm:gap-12 items-center max-w-8xl mx-auto px-4 sm:px-6 py-10 sm:py-16 bg-gradient-to-br from-black via-gray-900 to-black">
      {/* Right side - Map */}
      ...
      <div className="flex-1 space-y-5 sm:space-y-6">
        <div className="space-y-2">
         <span className="inline-flex items-center gap-2 text-blue-400 text-xs sm:text-sm font-semibold tracking-wider uppercase bg-blue-500/10 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-blue-500/20 transform shadow-[0_8px_30px_rgba(59,130,246,0.3)] relative">
        ...
        <div className="space-y-3 sm:space-y-4 pt-2">
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
              <img className='w-8 h-8 sm:w-10 sm:h-10 object-cover' src="https://img.icons8.com/3d-fluency/94/place-marker.png" alt="location"/>
            </div>
            <div>
              <p className="text-gray-500 text-[0.65rem] sm:text-xs font-medium uppercase tracking-wider">Location</p>
              <p className="text-gray-300 text-sm sm:text-base group-hover:text-white transition-colors">123 Main Street, City, Country</p>
            </div>
          </div>
          
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
              <img className='w-8 h-8 sm:w-10 sm:h-10 object-cover' src="https://img.icons8.com/3d-fluency/94/phone-disconnected.png" alt="contact"/>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
              <img className='w-8 h-8 sm:w-10 sm:h-10 object-cover' src="https://img.icons8.com/3d-fluency/94/mail.png" alt="contact"/>
            </div>
            <div>
