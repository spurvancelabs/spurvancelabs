...
function PricingService() {
  return (
    <div className='py-20 px-4 relative min-h-screen flex items-center mt-8 overflow-hidden'>
        {/* Large Background Heading */}
        <div className='absolute inset-0 bottom-295 flex items-center justify-center pointer-events-none'>
            <h1 className='text-[3rem] sm:text-[5rem] md:text-[8rem] lg:text-[12rem] font-bold text-white select-none tracking-wider'>
                Interships
            </h1>
        </div>
        ...
        <div className='relative z-10 w-full max-w-6xl mx-auto'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                {/* Free Plan */}
                <div className='backdrop-blur-xs bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/5 group relative'>
                    <div className='text-center'>
                        <span className='text-white/40 text-xs uppercase tracking-[0.25em] font-medium'>Free Plan</span>
                        <h3 className='text-white font-bold text-3xl sm:text-4xl md:text-5xl mt-3'>Free</h3>
                ...
                <div className='backdrop-blur-xs bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/5 group relative'>
                    ...
                    <div className='text-center'>
                        ...
                        <h3 className='text-white font-bold text-3xl sm:text-4xl md:text-5xl mt-3'>$9.99<span className='text-xl text-white/40'>/mo</span></h3>
                ...
                <div className='backdrop-blur-xs bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/5 group relative'>
                    <div className='text-center'>
                        ...
                        <h3 className='text-white font-bold text-3xl sm:text-4xl md:text-5xl mt-3'>$19.99<span className='text-xl text-white/40'>/mo</span></h3>
            ...
            <div className="absolute left-100 -top-20 w-20 h-20 border-b border-white/20 rounded-full bg-gradient-to-br from-gray-700 via-gray-900 to-black shadow-[inset_-10px_-10px_30px_rgba(0,0,0,0.8),inset_10px_10px_30px_rgba(255,255,255,0.15),0_10px_40px_rgba(0,0,0,0.5)] relative cursor-pointer transition-transform duration-300 before:content-[''] before:absolute before:top-3 before:left-8 before:w-6 before:h-6 before:filter before:blur-[5px] before:bg-white/20 before:rounded-full before:rotate-[-30deg] after:bg-white/30 after:rounded-full hidden md:block"></div>
