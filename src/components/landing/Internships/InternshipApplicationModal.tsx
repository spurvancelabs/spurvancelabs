...
import { submitInternshipApplication } from '@/lib/api/applications';
...
const yearOfStudyOptions = [
  'Freshman', 'Sophomore', 'Junior', 'Senior', 'Graduate', 'PhD', 'Recently Graduated',
];

const availabilityDurationOptions = [
  '1 month', '2 months', '3 months', '4 months', '6 months', 'Summer',
];
...
export default function InternshipApplicationModal({ internship, onClose }: InternshipApplicationModalProps) {
    ...
    return (
      <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
        <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-[#666] mb-6">Thank you for applying to {internship.title}. We&apos;ll review your application and get back to you soon.</p>
          <button
            onClick={onClose}
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-track-black scrollbar-thumb-white/20 hover:scrollbar-thumb-white/40">
        <div className="sticky top-0 bg-[#0a0a0a] border-b border-[#1a1a1a] px-6 py-4 flex items-center justify-between z-10">
          <div>
            <h2 className="text-white text-xl font-semibold">Apply for {internship.title}</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">University *</label>
              <input
                type="text"
                name="university"
                required
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">Major *</label>
              <input
                type="text"
                name="major"
                required
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">Year of Study *</label>
              <select
                name="yearOfStudy"
                required
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">Graduation Date</label>
              <input
                type="date"
                name="graduationDate"
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">GPA</label>
              <input
                type="text"
                name="gpa"
                value={formData.gpa}
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">GitHub URL</label>
              <input
                type="url"
                name="githubUrl"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Tell us why you'd be a great intern..."
            />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-[#888] text-sm mb-1">Available Start Date</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-[#888] text-sm mb-1">Availability Duration</label>
              <select
              ...
              >
                ...
                {availabilityDurationOptions.map(opt => (
                  <option key={opt} value={opt}>{opt}</option>
                ))}
              </select>
            </div>
