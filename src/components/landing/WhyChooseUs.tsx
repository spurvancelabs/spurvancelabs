    ...
    <section className="py-20 px-8 pb-24 overflow-hidden">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="text-left lg:text-left">
          ...
          <h2 className="text-white text-[2.8rem] font-bold tracking-[-0.03em] mb-4 leading-[1.2]">
          ...
          <p className="text-[#666] text-[1.05rem] leading-[1.8] max-w-[500px] mb-10 lg:max-w-[500px]">
          ...
          <div className="flex flex-col gap-[0.2rem] lg:max-w-[600px] lg:mx-0 mx-auto">
            ...
            >
              ...
              <div className="feature-content">
                <h4 className="text-white text-[1rem] font-semibold mb-[0.3rem]">10+ Years Experience</h4>
                <p className="text-[#666] text-[0.85rem] leading-[1.5]">Proven track record of delivering successful projects</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="feature-content">
                <h4 className="text-white text-[1rem] font-semibold mb-[0.3rem]">500+ Projects Completed</h4>
                <p className="text-[#666] text-[0.85rem] leading-[1.5]">From startups to Fortune 500 companies</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="feature-content">
                <h4 className="text-white text-[1rem] font-semibold mb-[0.3rem]">98% Client Retention</h4>
                <p className="text-[#666] text-[0.85rem] leading-[1.5]">We build lasting relationships with our clients</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          <div 
            className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl px-8 py-[1.8rem] flex items-center gap-6 transition-[0.5s_cubic-bezier(0.25,0.46,0.45,0.94)] relative overflow-hidden opacity-0 translate-x-[60px] [&.visible]:opacity-100 [&.visible]:translate-x-0 hover:border-[#2a2a2a] hover:translate-x-[10px] lg:hover:!translate-x-[10px] hover:bg-[#111] flex-col sm:flex-row text-center sm:text-left"
            data-delay="0" 
          ...
          >
            ...
            <div className="flex-1 relative z-[1]">
              <h3 className="text-white text-[1.1rem] font-semibold mb-[0.3rem]">Fast &amp; Reliable</h3>
              <p className="text-[#666] text-[0.85rem] leading-[1.5] m-0">Lightning-fast development with robust, scalable solutions</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-1 relative z-[1]">
              <h3 className="text-white text-[1.1rem] font-semibold mb-[0.3rem]">Quality First</h3>
              <p className="text-[#666] text-[0.85rem] leading-[1.5] m-0">Rigorous testing and quality assurance in every project</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-1 relative z-[1]">
              <h3 className="text-white text-[1.1rem] font-semibold mb-[0.3rem]">Passionate Team</h3>
              <p className="text-[#666] text-[0.85rem] leading-[1.5] m-0">Dedicated professionals who love what they do</p>
            </div>
          </div>
        </div>
      </div>
