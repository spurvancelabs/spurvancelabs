...
const icons: Record<string, React.ReactNode> = {
  ...
  assignments: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>,
}
...
const navItems: NavItem[] = [
  ...
  { href: '/lms/instructor/categories', label: 'Categories', icon: 'categories' },
  { href: '/lms/instructor/enrollments', label: 'Enrollments', icon: 'enrollments' },
  { href: '/lms/instructor/analytics', label: 'Analytics', icon: 'analytics' },
  { href: '/lms/instructor/assignments', label: 'Assignments', icon: 'assignments' },
  { href: '/lms/instructor/profile', label: 'Profile', icon: 'profile' },
]
