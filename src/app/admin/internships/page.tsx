  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        >
          <img src="https://img.icons8.com/3d-fluency/18/plus.png" alt="" className="w-[18px] h-[18px]" />
          Add Internship
        </button>
      </div>
                  ...
                  <tr key={internship.id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        >
                          <img src="https://img.icons8.com/3d-fluency/18/pencil.png" alt="" className="w-[18px] h-[18px]" />
                        </button>
                        <button
                        ...
                        >
                          <img src="https://img.icons8.com/3d-fluency/18/trash-can.png" alt="" className="w-[18px] h-[18px]" />
                        </button>
                      </div>
                    </td>
                  </tr>
