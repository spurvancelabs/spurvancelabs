  ...
  return (
    <div className="space-y-6">
      ...
      <ApplicationDetailModal
        ...
        application={selectedApp ? { ...selectedApp, applicationType: 'job' } : null}
        jobInfo={jobData ? { id: jobData.id, title: jobData.title, department: jobData.department, type: jobData.type, location: jobData.location } : null}
      />
    </div>
  );
}
